        ...
        <div class="min-h-full">
            ...
            <div class="md:hidden" id="mobile-menu">
                ...
                <div class="flex items-center px-5">
                    ...
                    <div class="ml-3">
                    <div class="text-base font-medium leading-none text-white">Ryan Villarante</div>
                    <div class="text-sm font-medium leading-none text-gray-400">ryan@example.com</div>
                    </div>
